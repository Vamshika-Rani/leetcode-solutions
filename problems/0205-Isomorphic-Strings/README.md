...
<picture>
  ...
  <img alt="Topics: Hash Table, String — best runtime 11 ms (Beats 58%), best memory 13.3 MB (Beats 92%)" src="panel-dark.svg">
</picture>
...
| # | File | Language | Date |
|:-:|------|:--------:|:----:|
| 1 | [sol1.py](./sol1.py) | `Python` | 2026-09-26 ← **latest** |
